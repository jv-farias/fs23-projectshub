...
export const MyProjectCard = async ({ project, user }: MyProjectCardProps) => {
  const likesCount = await db.like.count({
    where: { projectId: project.id },
  });

  return (
    <Card className="max-w-[280px] max-md:min-w-[80%] min-w-[280px] flex flex-col gap-4 p-4 rounded-2xl">
